    ...
    def threeSumClosest(self, nums: List[int], target: int) -> int:
        ...
        for i in range(0, len(nums)-2):
            ...
            while low != high:
                ...
                if abs(target - sum_) < abs(target - result_sum):
                    result_sum = sum_
                if sum_ < target:
                    low += 1
                else:
